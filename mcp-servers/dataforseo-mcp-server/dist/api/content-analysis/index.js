...
function registerContentAnalysisTools(server, apiClient) {
  ...
  (0, tools_js_1.registerTool)(
    ...
    zod_1.z.object({
      ...
      calculate_sentiment: zod_1.z
        .boolean()
        .optional()
        .describe("Calculate sentiment"),
      calculate_toxicity: zod_1.z
        .boolean()
        .optional()
        .describe("Calculate toxicity"),
      calculate_readability: zod_1.z
        .boolean()
        .optional()
        .describe("Calculate readability"),
      calculate_keyword_density: zod_1.z
        .boolean()
        .optional()
        .describe("Calculate keyword density"),
      calculate_information_score: zod_1.z
        .boolean()
        .optional()
        .describe("Calculate information score"),
      calculate_adult_score: zod_1.z
        .boolean()
        .optional()
        .describe("Calculate adult score"),
    }),
    async (params, client) => {
      const response = await client.post("/content_analysis/summary/live", [
        params,
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    async (params, client) => {
      const response = await client.post("/content_analysis/search/live", [
        params,
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    async (params, client) => {
      const response = await client.post("/content_analysis/category/live", [
        params,
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    zod_1.z.object({
      rating_values: zod_1.z
        .array(zod_1.z.number())
        .describe("Array of rating values"),
      algo: zod_1.z
