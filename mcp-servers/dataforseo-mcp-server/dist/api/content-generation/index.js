...
function registerContentGenerationTools(server, apiClient) {
  ...
  (0, tools_js_1.registerTool)(
    ...
    async (params, client) => {
      const response = await client.post("/content_generation/text/live", [
        params,
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    zod_1.z.object({
      text: zod_1.z
        .string()
        .optional()
        .describe("Text to generate meta tags from"),
    ...
    async (params, client) => {
      const response = await client.post("/content_generation/meta_tags/live", [
        params,
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    zod_1.z.object({
      ...
      language_code: zod_1.z.string().optional().describe("Language code"),
      language_name: zod_1.z.string().optional().describe("Language name"),
      summary_size: zod_1.z
        .enum(["small", "medium", "large"])
        .optional()
        .describe("Summary size"),
    }),
    async (params, client) => {
      const response = await client.post("/content_generation/summarize/live", [
        params,
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    async (params, client) => {
      const response = await client.post("/content_generation/title/live", [
        params,
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    zod_1.z.object({
      ...
      language_code: zod_1.z.string().optional().describe("Language code"),
      language_name: zod_1.z.string().optional().describe("Language name"),
      code_language: zod_1.z
        .string()
        .optional()
        .describe("Programming language of the code"),
      explanation_type: zod_1.z
