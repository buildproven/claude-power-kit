...
function registerOnPageTools(server, apiClient) {
  ...
  (0, tools_js_1.registerTool)(
    ...
    zod_1.z.object({
      ...
      max_crawl_pages: zod_1.z
        .number()
        .optional()
        .describe("Maximum number of pages to crawl"),
      load_resources: zod_1.z
        .boolean()
        .optional()
        .describe("Load page resources"),
      enable_javascript: zod_1.z
        .boolean()
        .optional()
  ...
  (0, tools_js_1.registerTool)(
    ...
    async (params, client) => {
      const { id, ...restParams } = params;
      const response = await client.post(`/on_page/resources/${id}`, [
        restParams,
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    async (params, client) => {
      const response = await client.post("/on_page/task_force_stop", [
        { id: params.id },
      ]);
      return response;
    },
  ...
  (0, tools_js_1.registerTool)(
    ...
    async (params, client) => {
      const { id, ...restParams } = params;
      const response = await client.post(`/on_page/duplicate_content/${id}`, [
        restParams,
      ]);
      return response;
    },
